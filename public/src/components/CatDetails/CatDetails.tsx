    ...
    <div className="w-full ms-5">
      <div className="text-start ms-4 mt-5">
        ...
        <div className="flex flex-col mt-5">
          ...
          <p style={{ color: '#5A7894' }} className="my-1">
            Expires 01/06/2023
          </p>
        </div>
      </div>
      ...
      <div
        ...
        style={{ color: '#25384D', fontWeight: '400', fontSize: '16px', lineHeight: '24px' }}
      >
        Take advantage of this limited-time offer for a comprehensive health insurance plan with enhanced benefits. This
        plan provides coverage for medical, hospitalization, and prescription drug expenses, ensuring you and your
        family have access to quality healthcare when you need it most. Enjoy the following:
        <br />
        <br />
        ...
        <ul className="ms-9 my-2" style={{ listStyleType: 'disc' }}>
          ...
          <li style={{ color: '#25384D' }}>
            Certain limitations and exclusions may apply. Please review the policy documentation for complete details.
          </li>
          <li style={{ color: '#25384D' }}>
            This offer is subject to the underwriting approval of the insurance provider.
          </li>
