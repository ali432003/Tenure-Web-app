...
export const  ChartHoverBox:React.FC<ComponentProps> = ({ active, payload, label })=> {
  if (active && payload && payload.length) {
    ...
    return (
<div className="custom-tooltip" style={{width: "185%", boxShadow:"0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1)",borderRadius:"10px", backgroundColor:"#f9f9f9"}}>
