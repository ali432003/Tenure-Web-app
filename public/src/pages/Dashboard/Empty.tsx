  ...
  return (
      ...
      <div className="rightSide w-full h-full ">
        ...
        <div className="mt-5">
          ...
          <div>
            <ul className="flex justify-end -mt-8">
              <li className={`${selectedCategory==='monthly'?'active':''} list-none rounded-lg p-2 cursor-pointer`} onClick={()=>setActive('monthly')}>
                Monthly
              </li>
              <li className={`${selectedCategory==='Weekly'?'active':''} list-none rounded-lg p-2 cursor-pointer`} onClick={()=>setActive('Weekly')}>
                Weekly
              </li>
              <li className={`${selectedCategory==='Daily'?'active':''} list-none rounded-lg p-2 cursor-pointer`} onClick={()=>setActive('Daily')}>
                Daily
              </li>
              <li className={`${selectedCategory==='All'?'active':''} list-none rounded-lg p-2 cursor-pointer`} onClick={()=>setActive('All')}>
                All time
              </li>
            </ul>
          </div>
        ...
        <div className="mt-5 ms-5 grid grid-cols-2 gap-4">
          <Box
            ...
            chart={
              ...
              <Tooltip content={<ChartHoverBox active={undefined} payload={undefined} label={undefined} />} cursor={{fill: 'transparent'}}/>
            </BarChart>
            }
          />
          <Box
            ...
            chart={
              <LineChart width={730} height={250} data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                ...
                <Tooltip content={<ChartHoverBox active={undefined} payload={undefined} label={undefined} />}   cursor={false} />
                <Line
                  type="monotone"
                  dataKey="amount"
        ...
        <div className="items-center justify-between text-start ms-9 mt-5">
          ...
          <h4 className="text-start">Active offers</h4>
