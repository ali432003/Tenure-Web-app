...
const EmployeeDealData = [
 ...
 const filteredRows = EmployeeDealData.filter((item: Item) => selectedCategory === 'all' || item.category === selectedCategory);
 ...
 const filteredRowsEmployer = EmployerDealData.filter((item: Item) => selectedCategory === 'all' || item.category === selectedCategory);
      ...
      <div className="w-full ms-5">
        ...
        <div className="w-11/12 ms-4 mt-9">
          <ul className="flex" id="emCat">
            ...
            <li
              className={`${selectedCategory === 'Health-care' ? 'active' : ''} list-none rounded-lg p-2 cursor-pointer`}
          ...
          <ul className="flex" id="emrCat" style={{ display: 'none' }}>
            ...
            <li
              className={`${selectedCategory === 'Professional Development' ? 'active' : ''} list-none rounded-lg p-2 cursor-pointer`}
              onClick={() => filterByCategory('Professional Development')}
            >
              Professional Development
            </li>
            <li
              className={`${selectedCategory === 'Local Business' ? 'active' : ''} list-none rounded-lg p-2 cursor-pointer`}
              onClick={() => filterByCategory('Local Business')}
            >
              local buisness
            </li>
            <li
              className={`${selectedCategory === 'Financial Services' ? 'active' : ''} list-none rounded-lg p-2 cursor-pointer`}
            ...
            <li
              className={`${selectedCategory === 'Community partnership' ? 'active' : ''} list-none rounded-lg p-2 cursor-pointer`}
        ...
        <div className='mt-10'>
           ...
           { filteredRows.map((item) => (
                <React.Fragment key={item.id}>
                    <EmTableRows className="group-hover:text-white"
                        rkey={'DealsTable'}
                        img={item.img}
                        brand={item.brand}
