    ...
    return (
        ...
        <div className="bg-gray-50 grid grid-cols-1">
            ...
            <div className="container min-w-full center  relative flex flex-col justify-center items-center">
                ...
                <p style={{
                    color: 'grey'
                }} className='w-1/3'>We’ve sent a password reset link to your email. Use this link to change your password.</p>
                <p style={{
                    color: 'grey'}}>Didn’t receive a link? <span className='text-md font-semibold align-bottom cursor-pointer' style={{color:"rgb(56 133 123 /1)"}}> <a href="/"> Resend Link </a></span></p>
            </div>
